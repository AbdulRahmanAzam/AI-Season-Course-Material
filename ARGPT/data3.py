...
DATASETS = {
    ...
    # ~10 MB of "User: ... / Buddy: ..." science chat, generated by
    # data/knowledge/build_knowledge_data.py. Nothing to download.
    # Same pretraining as Shakespeare -- the ONLY difference is that this text
    # is already shaped like a conversation, so the model falls into that shape.
    "knowledge": None,
}
